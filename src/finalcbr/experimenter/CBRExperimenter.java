...
public class CBRExperimenter {
	/**
	 * Variables for the experiment and database setup
	 */
	private static final File configFile = new File("brexp/setup.properties");
	private static final ICBRExperimenterConfig m = (ICBRExperimenterConfig) ConfigFactory.create(ICBRExperimenterConfig.class).loadPropertiesFromFile(configFile);
	...
	private static final Logger logger = LoggerFactory.getLogger(CBRExperimenter.class);
